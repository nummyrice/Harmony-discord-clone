...
export default function CreateServer({ setCreateNewServer, setServerActive }) {
  ...
  const validate = () => {
    ...
    if (!imageUrl)
      validationErrors.push("image : Add a server image to make it your own.");
  ...
  return (
    <>
      ...
      <div className={style.newServerContainer}>
        <form className={style.newServerForm} onSubmit={handleSubmit}>
          <div
          ...
          <div className={style.newServerContent}>
            <div className={style.imgIconContainer}>
              <label className={style.newServerImgLabel} for="imgFile">
                {imgFile ? (
                  imgFile && (
                    <img src={imgFile} className={style.newServerImgPreview} />
                  )
                ) : (
                  <svg width="80" height="80" viewBox="0 0 80 80">
                    ...
                    <path
                      ...
                      fill="white"
                    ></path>
                    <path d="M40 29C37.794 29 36 30.794 36 33C36 35.207 37.794 37 40 37C42.206 37 44 35.207 44 33C44 30.795 42.206 29 40 29Z"></path>
            ...
            <div className={style.newServerInputWrapper}>
              <label className={style.newServerLabel}>
                SERVER NAME
                <span className={style.newServerSpan}>
                  {errors.length > 0 &&
          ...
          <div className={style.newServerButtons}>
            <div className={style.newServerBack} onClick={() => goBack()}>
              Back
            </div>
            <button className={style.newServerSubmit}>Create</button>
          </div>
        </form>
      </div>
    </>
