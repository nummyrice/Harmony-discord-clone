...
const EditChannel = ({setEditChannelModalActive}) => {
    ...
    const channelIcon = (
        <svg width="14" height="14" viewBox="0 0 24 24" class="icon-1DeIlz">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
    ...
    return (
        <>
            <form onSubmit={handleSubmit} className='channel-create-form'>
                ...
                <div className='form-btn-wrapper edit-form-btns'>
                    <DeleteChannel setEditChannelModalActive={setEditChannelModalActive}/>
                    <div>
                        <p onClick={() => {setEditChannelModalActive(false)}} className='cancelLink'>Cancel</p>
